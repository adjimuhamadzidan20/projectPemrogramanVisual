...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Jun 2022 pada 07.41
...
('PL04', 'Adji', 'Laki Laki', 'Jl Raya Hankam'),
...
--
ALTER TABLE `data_keuangan`
  MODIFY `id_uang` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
