...
public class datakeuangan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_cetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 300, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 60, 780, 227));
        ...
        jPanel1.add(btn_reset1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, -1, -1));
        ...
        if(uang.equals("") || idanggota.equals("") || bulan.equals("") || ket.equals("")){
            ...
            if(konfir == 0){
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Data keuangan berhasil ditambahkan","Informasi",JOptionPane.INFORMATION_MESSAGE);
                    showData();
                    reset();
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, e.getMessage());
